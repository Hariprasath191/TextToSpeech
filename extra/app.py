...
# ============================================================================
MAX_CHARACTER_LIMIT = 50000  # Maximum characters allowed (change this number!)
# ============================================================================
...
def generate():
    ...
    try:
        ...
        if len(text) > MAX_CHARACTER_LIMIT:
            return jsonify({'error': f'Text is too long. Maximum {MAX_CHARACTER_LIMIT:,} characters.'}), 400
